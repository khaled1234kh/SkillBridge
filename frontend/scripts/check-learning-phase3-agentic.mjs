...
expect(page.includes('Python code is not executed here'), 'UI must disclose non-execution of submitted Python')
expect(page.includes('Static code check / فحص ثابت للكود'), 'UI must label non-executing static checks clearly')
